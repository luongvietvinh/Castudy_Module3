...
public class Manager {
    ...
    public Manager(int id, String user_name, String passwords,String full_name, String email, String phone, String address, String img, double salary, double coefficients_salary, String status, Date create_date, Date modify_date, String name_role) {
    ...
    public Manager(int id_role, String user_name, String passwords, String full_name, String email, String phone, String address, String img, Double salary, Double coefficients_salary, String status, Date create_date, Date modify_date) {
